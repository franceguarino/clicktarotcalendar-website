...
const en: Dictionary = {
	...
	pricing: {
		...
		freeVersionNote:
			'Prefer to try it free first? <a href="https://wordpress.org/plugins/francesco-guarino-booking-calendar/" target="_blank" rel="noopener">Get it on WordPress.org</a>.',
	...
	compareIndex: {
		eyebrow: 'Compare',
		title: 'See how clickTarot Calendar compares',
		subtitle:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					"Pick a single way to answer - WhatsApp, email from the WordPress panel, or your own inbox - and that's exactly what the public form promises whoever writes in.",
				],
