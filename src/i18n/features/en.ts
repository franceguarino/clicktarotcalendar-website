...
const en: FeatureDetailDictionary = {
	...
	freeReadings: {
		...
		tagline: 'Turn the curious into clients: a free question today, <span class="ct-accent">a paid booking</span> tomorrow.',
		metaDescription:
